# TG-MusicPlayer
A Telegram Userbot to play Audio and Video songs / files OTHER YOUTUBE & M3U8 in Telegram Voice Chats.
...
3) Cloning the Repo
```bash
git clone https://github.com/Devansh20055/TG-MusicPlayer
cd TG-MusicPlayer
```
